...
public class RelatudeFishingShop_FrontPageController : WAF.Server.Controllers.ContentController<WAF.API.RelatudeFishingShop.FrontPage> { 
public RelatudeFishingShop_FrontPageController(AdminUIAPIControllerContext ctx) : base(ctx) {    }
}
public class RelatudeFishingShop_ModuleBaseController : WAF.Server.Controllers.ContentController<WAF.API.RelatudeFishingShop.ModuleBase> { 
public RelatudeFishingShop_ModuleBaseController(AdminUIAPIControllerContext ctx) : base(ctx) {    }
}
public class RelatudeFishingShop_SliderModuleController : WAF.Server.Controllers.ContentController<WAF.API.RelatudeFishingShop.SliderModule> { 
public RelatudeFishingShop_SliderModuleController(AdminUIAPIControllerContext ctx) : base(ctx) {    }
}
public class RelatudeFishingShop_ImageAndTextModuleController : WAF.Server.Controllers.ContentController<WAF.API.RelatudeFishingShop.ImageAndTextModule> { 
public RelatudeFishingShop_ImageAndTextModuleController(AdminUIAPIControllerContext ctx) : base(ctx) {    }
}
public class RelatudeFishingShop_ProductsModuleController : WAF.Server.Controllers.ContentController<WAF.API.RelatudeFishingShop.ProductsModule> { 
public RelatudeFishingShop_ProductsModuleController(AdminUIAPIControllerContext ctx) : base(ctx) {    }
}
public class RelatudeFishingShop_ControlPanelController : WAF.Server.Controllers.ContentController<WAF.API.RelatudeFishingShop.ControlPanel> { 
public RelatudeFishingShop_ControlPanelController(AdminUIAPIControllerContext ctx) : base(ctx) {    }
}
public class RelatudeFishingShop_RelatudeFishingShopOrderItemController : WAF.Server.Controllers.ContentController<WAF.API.RelatudeFishingShop.RelatudeFishingShopOrderItem> { 
public RelatudeFishingShop_RelatudeFishingShopOrderItemController(AdminUIAPIControllerContext ctx) : base(ctx) {    }
}
public class RelatudeFishingShop_ProductController : WAF.Server.Controllers.ContentController<WAF.API.RelatudeFishingShop.Product> { 
public RelatudeFishingShop_ProductController(AdminUIAPIControllerContext ctx) : base(ctx) {    }
}
public class RelatudeFishingShop_ArticleController : WAF.Server.Controllers.ContentController<WAF.API.RelatudeFishingShop.Article> { 
public RelatudeFishingShop_ArticleController(AdminUIAPIControllerContext ctx) : base(ctx) {    }
}
public class RelatudeFishingShop_RelatudeFishingShopProductCategoryController : WAF.Server.Controllers.ContentController<WAF.API.RelatudeFishingShop.RelatudeFishingShopProductCategory> { 
public RelatudeFishingShop_RelatudeFishingShopProductCategoryController(AdminUIAPIControllerContext ctx) : base(ctx) {    }
}
